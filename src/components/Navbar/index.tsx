    ...
    <div className='sticky left-0 right-0 top-0 z-20 flex items-center justify-between bg-transparent p-6'>
      <div className='flex h-10 items-center space-x-2.5'>
        <div className='space-x-1.5'>
          <IconButton icon={<GoChevronLeft className='h-5 w-5' />} intent={'secondary'} size={'extraSmall'} />
          <IconButton icon={<GoChevronRight className='h-5 w-5' />} intent={'secondary'} size={'extraSmall'} />
        </div>
